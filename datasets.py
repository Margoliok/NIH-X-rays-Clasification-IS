...
class XRaysTrainDataset(Dataset):
    ...
    def get_train_val_df(self):
        ...
        image_names = self.df['image_links'].apply(os.path.basename)
        train_val_df = self.df.loc[image_names.isin(train_val_list)].copy()
    ...
    def get_train_val_list(self):
        ...
        train_val_list = [name for name in str.split(f.read(), '\n') if name]
...
class XRaysTestDataset(Dataset):
    ...
    def get_test_df(self):
        ...
        print('\nbuilding test_df...')
        image_names = self.df['image_links'].apply(os.path.basename)
        test_df = self.df.loc[image_names.isin(test_list)].copy()
    ...
    def get_test_list(self):
        ...
        test_list = [name for name in str.split(f.read(), '\n') if name]
        return test_list
